//
//  ExcelliCodingTests.swift
//  ExcelliCodingTestTests
//


import XCTest
@testable import ExcelliCodingTest

class ExcelliExploreCardTableViewControllerTests: XCTestCase {

    var testInstance: ExcelliExploreCardTableViewController!
    
    override func setUp() {
        testInstance = UIStoryboard(name: "Main", bundle: Bundle.main).instantiateInitialViewController() as? ExcelliExploreCardTableViewController
    }
